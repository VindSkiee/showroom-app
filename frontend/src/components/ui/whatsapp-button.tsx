    ...
    >
      <div className="mx-auto flex max-w-2xl items-center justify-between px-4 py-3">
        <div className="flex flex-col">
          <span className="text-sm font-medium text-ink">Chat via WhatsApp</span>
          <span className="text-xs text-ink-muted">Respon cepat</span>
        </div>
        <div className="flex h-12 items-center gap-2 rounded-xl bg-[#25D366] px-6 text-base font-semibold text-white">
